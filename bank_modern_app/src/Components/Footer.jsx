  ...
  return (
    <section className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      <div className={`${styles.flexStart} md:flex-row flex-col mb-8 w-full`}>
        ...
        <div className="flex-[1.5] w-full justify-between flex flex-wrap md:mt-0 mt-10">
      ...
      <div className="w-full flex md:flex-row flex-col pt-6 justify-between items-center border-t-[1px] border-t-[#3F3E45]">
